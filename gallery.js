const COS_URL = "https://chenjt-portfolio-1420941215.cos.ap-shanghai.myqcloud.com/";

const galleryData = [
  { 
    src: COS_URL + "images/DSC_1833.webp", 
    alt: "武汉的钢铁丛林",
    caption: "秩序的钢铁丛林，有无数的梦想在这里生根发芽" ,
    span:"full"
  },
  { 
    src: COS_URL + "images/the_dream_land.webp", 
    alt: "梦想之地",
    caption: "梦想之地，充满无限可能" ,
    span: "half"
  },
  { 
    src: COS_URL + "images/DSC_3567.webp", 
    alt: "东京的暮色",
    caption: "暮色倒灌进钢铁丛林的缝隙。在这场黑白的默片里，庞大的都市静默如海。" ,
    span: "half"
  },
  { 
    src: COS_URL + "images/DSC_1890.webp", 
    alt: "深夜的武汉",
    caption: "深夜的城市剥落了白日的伪装，化作一头以光流为血脉的钢铁巨兽。" ,
    span: "quarter"
  },
  { 
    src: COS_URL + "images/shuangzita.webp", 
    alt: "双子塔",
    caption: "我们修筑通往云端的阶梯，直到躯壳在光芒中消散，塔尖归于虚无。" ,
    span: "quarter"
  },
  { 
    src: COS_URL + "images/DSC_3552.webp", 
    alt: "街道鸿沟两端的烟火与安宁",
    caption: "街道的片刻安宁，是被两端的烟火夹击着的。它们在光影里交织成一场无声的对峙。" ,
    span: "half"
  },
  { 
    src: COS_URL + "images/DSC_1224.webp", 
    alt: "斑驳墙头巡视领地的猫",
    caption: "它踩着斑驳的碎光巡视领地。墙外是喧嚣的人间，墙上是只属于它的慵懒纪元。" ,
    span: "full"
  },
  { 
    src: COS_URL + "images/kashi_football_boys.webp", 
    alt: "踢球的男孩",
    caption: "在这一瞬间只有对足球的热爱和纯粹的快乐。" ,
    span: "half"
  },
  { 
    src: COS_URL + "images/kind_old_man.webp", 
    alt: "慈祥的老者",
    caption: "岁月在他脸上刻下了痕迹，他是时间的见证者。" ,
    span: "quarter"
  },
  { 
    src: COS_URL + "images/twin_sisters_in_kashi.webp", 
    alt: "双胞胎姐妹",
    caption: "西域的街道充满了神秘的色彩，这对双胞胎姐妹在其中如同童话中的精灵。" ,
    span: "quarter"
  },
  { 
    src: COS_URL + "images/DSC_3371.webp", 
    alt: "京都黄昏下交织的电线与守候的灯笼",
    caption: "电线网切碎了京都的黄昏，灯笼守候着夜。一不小心，就会踩到旧时光斑驳的倒影。" ,
    span: "quarter"
  },
  { 
    src: COS_URL + "images/DSC_3275.webp", 
    alt: "大阪列车站交错的光影虚影",
    caption: "大阪列车的虚影划破空间，都市的脉搏在快门下凝固成斑驳的流光。" ,
    span: "quarter"
  },
  { 
    src: COS_URL + "images/DSC_3393.webp", 
    alt: "京都二年坂沉淀温度的青石板路",
    caption: "京都的青石板路，时间在这里沉淀出苔藓的温度。每一步，都像是踩在江户时代的影子里。", 
    span: "quarter"
  },
  { 
    src: COS_URL + "images/Tokyo_Tower.webp", 
    alt: "东京塔下的城市霓虹与航标",
    caption: "所有的跋涉，都是为了抵达这片霓虹的彼岸。在东京的潮汐里，它是唯一永恒的航标。" ,
    span: "quarter"
  },
  { 
    src: COS_URL + "images/DSC_3549.webp", 
    alt: "玻璃幕墙后的城市雨景与咖啡馆坐标",
    caption: "玻璃弧线切开了光影的象限。在这个坐标，现实与幻境之间，只隔着一场新海诚式的阵雨。" ,
    span: "quarter"
  },
  { 
    src: COS_URL + "images/Kelingking_Beach.webp", 
    alt: "佩尼达岛精灵坠崖的雨幕绝景",
